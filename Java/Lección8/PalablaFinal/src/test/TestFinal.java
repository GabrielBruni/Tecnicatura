...
estático para convertir una variable en una constante, es decir, que no se puede modificar su valor, el ejemplo 
de esto es la clase Math en la cuál todos sus atributos son de tipo static y final; es por esto que la variable 
...
public class TestFinal {
    public static void main(String[] args) {
        final int miDni = 42793717;
        System.out.println("miDni = " + miDni);
        //miDni = 35185971;  // No se puede modificar.
        //Persona.CONSTANTE_AQUI = 9; // No se modifica.
        System.out.println("Mi atributo constante es: "+Persona.CONSTANTE_AQUI);
        
        final Persona persona1 = new Persona();
        //persona1 = new Persona(); // No se puede asignar una nueva referencia.
        persona1.setNombre("Gabriel Bruni");
        System.out.println("persona1 nombre: "+persona1.getNombre());
        persona1.setNombre("Virginia");
        System.out.println("persona1 nombre: "+persona1.getNombre());
    }   
}
